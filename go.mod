...
// Pin goleak to v1.2.0: v1.3.0 uses errors.Join and strings.CutPrefix which
// require Go 1.20, but the release-4.12 builder uses Go 1.19.
replace go.uber.org/goleak => go.uber.org/goleak v1.2.0
